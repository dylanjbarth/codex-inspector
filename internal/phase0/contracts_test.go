...
func TestReviewSchemas(t *testing.T) {
	...
	run := map[string]any{
		...
		"createdAt": "2026-07-18T12:00:00Z", "startedAt": "2026-07-18T12:00:01Z", "command": []any{"codex", "exec", "--json"}, "threadId": "fake-review-thread", "pid": float64(1234), "launchPromptVersion": "inspector.review-launch/v1",
	}
