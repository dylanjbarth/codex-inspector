...
go build ./...
shellcheck install.sh plugin/codex-inspector/hooks/inspector-hook.sh scripts/*.sh scripts/phase0/*.sh scripts/phase1/*.sh scripts/phase2/*.sh scripts/phase3/*.sh scripts/phase4/*.sh scripts/phase5/*.sh scripts/phase6/*.sh
