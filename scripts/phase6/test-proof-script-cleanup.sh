...
grep -q 'v0.1.1' "${repo_root}/plugin/codex-inspector/skills/open-dashboard/SKILL.md"
if grep -q 'releases/download/v0.1.0' "${repo_root}/plugin/codex-inspector/skills/open-dashboard/SKILL.md"; then exit 1; fi
rm -rf -- "${proof_root}"
